...
export function DownloadCta() {
  ...
  const primary: KnownPlatform =
    mobile || platform === 'unknown' ? 'mac' : (platform as KnownPlatform);
    ...
    <section id="download" className="px-4 py-9 sm:px-10 md:py-[84px]">
      ...
      <div className="relative mx-auto max-w-[1160px] overflow-hidden rounded-[clamp(22px,3vw,40px)] border border-line-soft bg-surface-2 px-6 py-12 text-ink sm:px-[72px] md:py-24">
        ...
        <div className="relative flex flex-col items-center gap-5 text-center">
          ...
          {mobile ? (
            <p className="mt-1.5 mb-0 max-w-[36ch] text-[15.5px] leading-[1.55] font-medium">
              CockpitZero is a desktop app — open this page on your computer and it&rsquo;s one
              keystroke away.
            </p>
          ) : (
          ...
          <p className="mt-1.5 mb-0 font-mono text-xs leading-[1.5] text-muted">
